...
| C7 | 서론 research question 직답·일관성 | 서론이 핵심 research question에 직접 답하고, 그 답이 페이퍼 전반에 일관되게 나타나게 한다 | high |
| C8 | 문단 구조·유기적 연결 | 각 문단이 첫 문장에서 요지를 밝히고 그것을 뒷받침하며, 근거는 압축적이고 앞뒤 문단이 유기적으로 연결되게 한다 | high |
